package com.sale.form;

import com.sale.dialog.Message;
import mnm.SALE.Main;
...
import com.sale.swing.noticeboard.ModelNoticeBoard;
import com.sale.swing.table.EventAction;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/sale/icon/profile.jpg")), "Jonh", "Male", "Java", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/sale/icon/profile1.jpg")), "Dara", "Male", "C++", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/sale/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/sale/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/sale/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/sale/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/sale/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
    ...
    private void initComponents() {
        ...
        noticeBoard = new com.sale.swing.noticeboard.NoticeBoard();
    ...
    private com.sale.swing.noticeboard.NoticeBoard noticeBoard;
